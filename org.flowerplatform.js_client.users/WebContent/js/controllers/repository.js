...
flowerProject.lazy.controller('UserDashboardCtrl', ['$scope', '$routeParams', '$location', 'Login', 'Repository','SearchType',
       function($scope, $routeParams, $location, Login, Repository, SearchType) {
	...
	$scope.createRepository = function() {
		$scope.newRepository = { '@class' : 'org.flowerplatform.core.node.remote.Node',nodeUri:'', properties: {'@class' : 'java.util.HashMap', user: Login.login , name:  '', description: '', extensions: [] }};
