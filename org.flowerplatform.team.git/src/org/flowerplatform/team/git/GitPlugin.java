...
public class GitPlugin extends AbstractFlowerJavaPlugin {
	...
	public void start(BundleContext bundleContext) throws Exception {
		...
		CorePlugin.getInstance().getNodeTypeDescriptorRegistry().getOrCreateCategoryTypeDescriptor(GIT_STAGING_CATEGORY);
		...
		CorePlugin.getInstance().getResourceService().addResourceHandler(GIT_SCHEME, new GitVirtualNodeResourceHandler(GIT_REPO_TYPE));
		CorePlugin.getInstance().getResourceService().addResourceHandler(GIT_SCHEME, new GitVirtualNodeResourceHandler(GIT_LOCAL_BRANCHES_TYPE));
		CorePlugin.getInstance().getResourceService().addResourceHandler(GIT_SCHEME, new GitVirtualNodeResourceHandler(GIT_REMOTE_BRANCHES_TYPE));
