...
public class DefaultPropertiesProvider extends AbstractController implements IPropertiesProvider {
	...
	public void populateWithProperties(Node node, ServiceContext<NodeService> context) {
		...
		for (IController element : propDescriptors) {
			...
			Object nodeDefaultPropertyValue = context
					.getService().getDefaultPropertyValue(node, propertyDescriptor.getName(), new ServiceContext<NodeService>(context.getService()));
