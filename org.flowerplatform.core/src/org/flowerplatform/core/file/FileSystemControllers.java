...
public class FileSystemControllers {
	...
	public void registerControllers() {
		...
		.addAdditiveController(PROPERTY_DESCRIPTOR, new PropertyDescriptor().setNameAs(FILE_IS_DIRECTORY).setTitleAs(CorePlugin.getInstance().getMessage("file.is.directory")).setReadOnlyAs(true).setContributeToCreationAs(true).setIsMandatoryAs(true).setTypeAs(PROPERTY_DESCRIPTOR_TYPE_BOOLEAN).setOrderIndexAs(-5))
