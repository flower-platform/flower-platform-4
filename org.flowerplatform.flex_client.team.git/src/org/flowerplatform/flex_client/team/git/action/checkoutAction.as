...
package org.flowerplatform.flex_client.team.git.action
{
	...
	public class checkoutAction extends ActionBase  {
		...
		override public function run():void {
			...
			node.nodeUri.substring(node.nodeUri.indexOf(":") + 1, index);
			repo = node.nodeUri.substring(node.nodeUri.indexOf(":") + 1, index);
			CorePlugin.getInstance().serviceLocator.invoke("GitService.checkoutBranch",["TestBranch", repo]);	
			Alert.show("OK, fac checkout");
		}
	}
}