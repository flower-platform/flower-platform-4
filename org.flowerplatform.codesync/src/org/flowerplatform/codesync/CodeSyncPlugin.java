...
public class CodeSyncPlugin extends AbstractFlowerJavaPlugin {
	...
	//
	// protected CodeSyncTypeCriterionDispatcherProcessor
	// codeSyncTypeCriterionDispatcherProcessor;
	//
	// /**
	...
	// public CodeSyncTypeCriterionDispatcherProcessor
	...
	// }
	//
	// public CodeSyncElementDescriptor getCodeSyncElementDescriptor(String
	// codeSyncType) {
	// // TODO CS/JS we should have a mapping; maybe send it to flex as a map;
	// for quick access; idem for relations
	// for (CodeSyncElementDescriptor descriptor :
	...
	public void start(BundleContext context) throws Exception {
		...
		addModelAdapterSet(NODE_LEFT, new ModelAdapterSet().setTypeProvider(nodeTypeProvider).addModelAdapter(CATEGORY_CODESYNC, new NodeModelAdapterLeft()));

		addModelAdapterSet(NODE_ANCESTOR, new ModelAdapterSet().setTypeProvider(nodeTypeProvider).addModelAdapter(CATEGORY_CODESYNC, new NodeModelAdapterAncestor()));
		...
		CorePlugin.getInstance().getNodeTypeDescriptorRegistry().getOrCreateTypeDescriptor(CODESYNC)
				...
				.addAdditiveController(PROPERTIES_PROVIDER, new ConstantValuePropertyProvider(CoreConstants.NAME, "Code Sync")).addCategory(CATEGORY_MODEL);

		CodeSyncSubscribableResourceProvider mdaSubscribableResourceProvider = new CodeSyncSubscribableResourceProvider(MDA_FILE);
		CorePlugin.getInstance().getNodeTypeDescriptorRegistry().getOrCreateTypeDescriptor(MDA).addAdditiveController(PROPERTIES_PROVIDER, mdaSubscribableResourceProvider)
				.addAdditiveController(CHILDREN_PROVIDER, mdaSubscribableResourceProvider)
				.addAdditiveController(PROPERTIES_PROVIDER, new ConstantValuePropertyProvider(CoreConstants.NAME, "MDA")).addCategory(CATEGORY_MODEL);
		...
		CorePlugin.getInstance().getNodeTypeDescriptorRegistry().getOrCreateTypeDescriptor(CODESYNC_ROOT).addCategory(CATEGORY_MODEL);

		CorePlugin.getInstance().getNodeTypeDescriptorRegistry().getOrCreateTypeDescriptor(MDA_ROOT).addCategory(CATEGORY_MODEL);

		CorePlugin.getInstance().getNodeTypeDescriptorRegistry().getOrCreateTypeDescriptor(DIAGRAM).addCategory(CATEGORY_MODEL);
		...
		CorePlugin.getInstance().getNodeTypeDescriptorRegistry().getOrCreateCategoryTypeDescriptor(CodeSyncConstants.CATEGORY_CODESYNC)
				.addAdditiveController(ADD_NODE_CONTROLLER, new CodeSyncAddNodeController()).addAdditiveController(REMOVE_NODE_CONTROLLER, new CodeSyncRemoveNodeController())
		...
		CorePlugin
				...
				.getOrCreateTypeDescriptor(MATCH)
				.addAdditiveController(PROPERTY_DESCRIPTOR,
						new PropertyDescriptor().setNameAs(ICONS).setTitleAs(getLabel("codesync.match.icons")).setTypeAs(MINDMAP_ICONS_WITH_BUTTON_DESCRIPTOR_TYPE))
				...
				.addAdditiveController(PROPERTY_DESCRIPTOR,
						new PropertyDescriptor().setNameAs(MATCH_MODEL_ELEMENT_TYPE).setTitleAs(getLabel("codesync.match.modelElementType")).setReadOnlyAs(true))
				.addAdditiveController(
						PROPERTY_DESCRIPTOR,
						new PropertyDescriptor().setNameAs(MATCH_CHILDREN_MODIFIED_LEFT).setTitleAs(getLabel("codesync.match.children.modifiedLeft")).setReadOnlyAs(true)
								.setTypeAs(PROPERTY_DESCRIPTOR_TYPE_BOOLEAN))
				.addAdditiveController(
						PROPERTY_DESCRIPTOR,
						new PropertyDescriptor().setNameAs(MATCH_CHILDREN_MODIFIED_RIGHT).setTitleAs(getLabel("codesync.match.children.modifiedRight")).setReadOnlyAs(true)
								.setTypeAs(PROPERTY_DESCRIPTOR_TYPE_BOOLEAN))
				.addAdditiveController(
						PROPERTY_DESCRIPTOR,
						new PropertyDescriptor().setNameAs(MATCH_CHILDREN_CONFLICT).setTitleAs(getLabel("codesync.match.children.conflict")).setReadOnlyAs(true)
								.setTypeAs(PROPERTY_DESCRIPTOR_TYPE_BOOLEAN))
				.addAdditiveController(
						PROPERTY_DESCRIPTOR,
						new PropertyDescriptor().setNameAs(MATCH_DIFFS_MODIFIED_LEFT).setTitleAs(getLabel("codesync.match.diffs.modifiedLeft")).setReadOnlyAs(true)
								.setTypeAs(PROPERTY_DESCRIPTOR_TYPE_BOOLEAN))
				.addAdditiveController(
						PROPERTY_DESCRIPTOR,
						new PropertyDescriptor().setNameAs(MATCH_DIFFS_MODIFIED_RIGHT).setTitleAs(getLabel("codesync.match.diffs.modifiedRight")).setReadOnlyAs(true)
								.setTypeAs(PROPERTY_DESCRIPTOR_TYPE_BOOLEAN))
				.addAdditiveController(
						PROPERTY_DESCRIPTOR,
						new PropertyDescriptor().setNameAs(MATCH_DIFFS_CONFLICT).setTitleAs(getLabel("codesync.match.diffs.conflict")).setReadOnlyAs(true)
								.setTypeAs(PROPERTY_DESCRIPTOR_TYPE_BOOLEAN))
				.addAdditiveController(
						PROPERTY_DESCRIPTOR,
						new PropertyDescriptor().setNameAs(MATCH_BODY_MODIFIED).setTitleAs(getLabel("codesync.match.body.modified")).setReadOnlyAs(true)
								.setTypeAs(PROPERTY_DESCRIPTOR_TYPE_BOOLEAN))
				.addSingleController(PROPERTY_FOR_ICON_DESCRIPTOR, new GenericValueDescriptor(CODESYNC_ICONS).setOrderIndexAs(-1000));
		...
		// codeSyncTypeCriterionDispatcherProcessor = new
		// CodeSyncTypeCriterionDispatcherProcessor();
		//
		// codeSyncElementDescriptors = new
		// ArrayList<CodeSyncElementDescriptor>();
		...
		// dependentFeatures.add(new
		// DependentFeature(NotationPackage.eINSTANCE.getView(),
		// NotationPackage.eINSTANCE.getEdge_Source(), true));
		// dependentFeatures.add(new
		// DependentFeature(NotationPackage.eINSTANCE.getView(),
		// NotationPackage.eINSTANCE.getEdge_Target(), true));
		// dependentFeatures.add(new
		// DependentFeature(NotationPackage.eINSTANCE.getView(),
		// NotationPackage.eINSTANCE.getView_PersistentChildren(), false));
		//
		...
		//
		// // extensions
		// getFeatureAccessExtensions().add(new
		// NamedElementFeatureAccessExtension(descriptors));
		//
		// getAddNewExtensions().add(new AddNewExtension_Note());
		// getAddNewExtensions().add(new AddNewExtension_TopLevelElement());
		//
		// getInplaceEditorExtensions().add(new
		// InplaceEditorExtension_Default());
		// getInplaceEditorExtensions().add(new InplaceEditorExtension_Note());
		//
		// // processors
		// EditorModelPlugin.getInstance().getDiagramUpdaterChangeProcessor().addDiagrammableElementFeatureChangeProcessor("edge",
		// new RelationDiagramProcessor());
		// EditorModelPlugin.getInstance().getDiagramUpdaterChangeProcessor().addDiagrammableElementFeatureChangeProcessor("classDiagram.wizardElement",
		// new ChildrenUpdaterDiagramProcessor());
		// EditorModelPlugin.getInstance().getDiagramUpdaterChangeProcessor().addDiagrammableElementFeatureChangeProcessor("classDiagram.wizardElement.wizardAttribute",
		// new TopLevelElementChildProcessor());
		// EditorModelPlugin.getInstance().getDiagramUpdaterChangeProcessor().addDiagrammableElementFeatureChangeProcessor("classDiagram.wizardElement.wizardAttribute",
		// new RelationsChangesDiagramProcessor());
		// EditorModelPlugin.getInstance().getDiagramUpdaterChangeProcessor().addDiagrammableElementFeatureChangeProcessor("classDiagram.wizardElement",
		// new RelationsChangesDiagramProcessor());
		//
		// getCodeSyncTypeCriterionDispatcherProcessor().addProcessor(WIZARD_ATTRIBUTE,
		// new WizardChildrenPropagatorProcessor());
		// getCodeSyncTypeCriterionDispatcherProcessor().addProcessor(WIZARD_ATTRIBUTE,
		// new WizardElementKeyFeatureChangedProcessor());
		// getCodeSyncTypeCriterionDispatcherProcessor().addProcessor(WIZARD_ELEMENT,
		// new WizardElementKeyFeatureChangedProcessor());
		//
		// CustomSerializationDescriptor macroRegexSD = new
		// CustomSerializationDescriptor(MacroRegex.class)
		...
		// // needs custom descriptor because it uses the builder template (i.e.
		// setters return the instance)
	...
	// /**
	// * Important: the code sync mapping and cache resources <b>must</b> be
	// loaded through the same {@link ResourceSet}.
	// */
	// public ResourceSet getOrCreateResourceSet(Object file, String
	// diagramEditorStatefulServiceId) {
	// Object project =
	// getProjectAccessController().getContainingProjectForFile(file);
	// DiagramEditorStatefulService service = (DiagramEditorStatefulService)
	// CommunicationPlugin.getInstance()
	// .getServiceRegistry().getService(diagramEditorStatefulServiceId);
	//
	// DiagramEditableResource diagramEditableResource = null;
	// if (project != null) {
	// String path =
	// EditorPlugin.getInstance().getFileAccessController().getAbsolutePath(project);
	// for (EditableResource er : service.getEditableResources().values()) {
	// DiagramEditableResource der = (DiagramEditableResource) er;
	// if
	// (EditorPlugin.getInstance().getFileAccessController().getAbsolutePath(der.getFile()).startsWith(path))
	// {
	...
	//
	// /**
	// * Saves all the resources from the {@link ResourceSet} where
	// <code>resourceToSave</code>
	// * is contained.
	// *
	// * @author Mariana
	// */
	...
	// EditorModelPlugin.getInstance().getLoadSaveOptions();
	...
	//
	// /**
	// * Discards the modifications from all the resources from the {@link
	// ResourceSet}
	...
	public Node getCodeSyncMappingRoot(Object project) {
		...
		// if
		// (!EditorPlugin.getInstance().getFileAccessController().exists(codeSyncElementMappingFile))
		// {
		...
		// cseRoot =
		// CodeSyncPackage.eINSTANCE.getCodeSyncFactory().createCodeSyncRoot();
	...
	// Object astCacheElementFile =
	// CodeSyncPlugin.getInstance().getProjectAccessController().getFile(project,
	// ACE_FILE_LOCATION);
	// Resource resource = CodeSyncPlugin.getInstance().getResource(resourceSet,
	// astCacheElementFile);
	// if
	// (!EditorPlugin.getInstance().getFileAccessController().exists(astCacheElementFile))
	// {
	...
	/**
	 * Executes the runnable and keeps it around to be executed when the
	 * descriptors need to be refreshed.
	 * 
	 * @param runnable
	 * 
	 * @author Mircea Negreanu
	...
	// }
	//
	// public List<RelationDescriptor>
	// getRelationDescriptorsHavingThisTypeAsSourceCodeSyncType(String type) {
	// List<RelationDescriptor> descriptors = new
	// ArrayList<RelationDescriptor>();
	// for (RelationDescriptor descriptor : getRelationDescriptors()) {
	...
	//
	// public List<RelationDescriptor>
	// getRelationDescriptorsHavingThisEndTypes(String sourceType, String
	// targetType) {
	// CodeSyncElementDescriptor sourceDescriptor =
	// getCodeSyncElementDescriptor(sourceType);
	// CodeSyncElementDescriptor targetDescriptor =
	// getCodeSyncElementDescriptor(targetType);
	// List<RelationDescriptor> descriptors = new
	// ArrayList<RelationDescriptor>();
	// for (RelationDescriptor descriptor : getRelationDescriptors()) {
	// boolean sourceTypeOk = false;
	// boolean targetTypeOk = false;
	// if (descriptor.getSourceCodeSyncTypes() != null &&
	// descriptor.getSourceCodeSyncTypes().contains(sourceType)) {
	// sourceTypeOk = true;
	// } else {
	// for (String category : sourceDescriptor.getCodeSyncTypeCategories()) {
	// if (descriptor.getSourceCodeSyncTypeCategories() != null &&
	// descriptor.getSourceCodeSyncTypeCategories().contains(category)) {
	// sourceTypeOk = true;
	// }
	// }
	// }
	// if (descriptor.getTargetCodeSyncTypes() != null &&
	// descriptor.getTargetCodeSyncTypes().contains(targetType)) {
	// targetTypeOk = true;
	// } else {
	// for (String category : targetDescriptor.getCodeSyncTypeCategories()) {
	// if (descriptor.getTargetCodeSyncTypeCategories() != null &&
	// descriptor.getTargetCodeSyncTypeCategories().contains(category)) {
	// targetTypeOk = true;
	// }
	// }
	// }
