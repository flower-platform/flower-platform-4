...
public class CodeSyncPlugin extends AbstractFlowerJavaPlugin {
	...
	public static final String ADDED_MARKER = "added";
	public static final String SYNC_MARKER = "sync";
	public static final String CHILDREN_SYNC_MARKER = "childrenSync";
	public static final String CONFLICT_MARKER = "conflict";
	public static final String CHILDREN_CONFLICT_MARKER = "childrenConflict";
...
//	}
	...
	public void start(BundleContext context) throws Exception {
		...
		codeSyncDescriptor.addAdditiveController(PropertyDescriptor.PROPERTY_DESCRIPTOR, new PropertyDescriptor().setNameAs(ADDED_MARKER));
		...
		codeSyncDescriptor.addAdditiveController(PropertyDescriptor.PROPERTY_DESCRIPTOR, new PropertyDescriptor().setNameAs(SYNC_MARKER));
		codeSyncDescriptor.addAdditiveController(PropertyDescriptor.PROPERTY_DESCRIPTOR, new PropertyDescriptor().setNameAs(CHILDREN_SYNC_MARKER));
