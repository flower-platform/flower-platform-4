...
public class JavaImageConstants {
	...
	public static final String IMG_ANNOTATION = "";
	
	public static final String DECORATOR_ABSTRACT = "abstract.gif";
	public static final String DECORATOR_FINAL = "final.gif";
	public static final String DECORATOR_VOLATILE = "volatile.gif";
	public static final String DECORATOR_STATIC = "static.gif";
	public static final String DECORATOR_NATIVE = "native.gif";
	public static final String DECORATOR_TRANSIENT = "transient.gif";
	public static final String DECORATOR_SYNCHRONIZED = "synchronized.gif";
