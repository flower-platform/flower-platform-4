...
public class MindMapPlugin extends AbstractFlowerJavaPlugin {
	...
	public void start(BundleContext bundleContext) throws Exception {
		...
		.addAdditiveController(PROPERTY_DESCRIPTOR, new PropertyDescriptor().setTypeAs(MINDMAP_STYLE_NAME_DESCRIPTOR_TYPE).setNameAs(STYLE_NAME)
		...
		.setPropertyLineRendererAs(PROPERTY_LINE_RENDERER_TYPE_STYLABLE)
				.setTitleAs(resourcesPlugin.getMessage("mindmap.font.family"))
		...
		.setTypeAs(PROPERTY_DESCRIPTOR_TYPE_DROP_DOWN_LIST).setNameAs(FONT_SIZE).setPropertyLineRendererAs(PROPERTY_LINE_RENDERER_TYPE_STYLABLE)
				.setTitleAs(resourcesPlugin.getMessage("mindmap.font.size"))
		...
		.addAdditiveController(PROPERTY_DESCRIPTOR, new PropertyDescriptor()
		.setTypeAs(PROPERTY_DESCRIPTOR_TYPE_BOOLEAN).setNameAs(FONT_BOLD).setPropertyLineRendererAs(PROPERTY_LINE_RENDERER_TYPE_STYLABLE)
		...
		.addAdditiveController(PROPERTY_DESCRIPTOR, new PropertyDescriptor()
		.setTypeAs(PROPERTY_DESCRIPTOR_TYPE_BOOLEAN).setNameAs(FONT_ITALIC).setPropertyLineRendererAs(PROPERTY_LINE_RENDERER_TYPE_STYLABLE)
		...
		.addAdditiveController(PROPERTY_DESCRIPTOR, new PropertyDescriptor()
		.setTypeAs(PROPERTY_DESCRIPTOR_TYPE_COLOR_PICKER).setNameAs(COLOR_TEXT).setPropertyLineRendererAs(PROPERTY_LINE_RENDERER_TYPE_STYLABLE)
		...
		.addAdditiveController(PROPERTY_DESCRIPTOR, new PropertyDescriptor()
		.setTypeAs(PROPERTY_DESCRIPTOR_TYPE_COLOR_PICKER).setNameAs(COLOR_BACKGROUND).setPropertyLineRendererAs(PROPERTY_LINE_RENDERER_TYPE_STYLABLE)
				...
				.addAdditiveController(PROPERTY_DESCRIPTOR, new PropertyDescriptor()
		.setTypeAs(PROPERTY_DESCRIPTOR_TYPE_COLOR_PICKER).setNameAs(CLOUD_COLOR).setPropertyLineRendererAs(PROPERTY_LINE_RENDERER_TYPE_STYLABLE)
		...
		// EDGE		
		.addAdditiveController(PROPERTY_DESCRIPTOR, new PropertyDescriptor()
		.setTypeAs(PROPERTY_DESCRIPTOR_TYPE_NUMBER).setNameAs(EDGE_WIDTH).setPropertyLineRendererAs(PROPERTY_LINE_RENDERER_TYPE_STYLABLE)
		...
		.addAdditiveController(PROPERTY_DESCRIPTOR, new PropertyDescriptor()
				.setTitleAs(resourcesPlugin.getMessage("mindmap.edge.style")).setTypeAs(PROPERTY_DESCRIPTOR_TYPE_DROP_DOWN_LIST)
				...
				.setOrderIndexAs(360))
		.addAdditiveController(PROPERTY_DESCRIPTOR, new PropertyDescriptor()
				.setTitleAs(resourcesPlugin.getMessage("mindmap.edge.color")).setTypeAs(PROPERTY_DESCRIPTOR_TYPE_COLOR_PICKER)
				.setPropertyLineRendererAs(PROPERTY_LINE_RENDERER_TYPE_STYLABLE)
