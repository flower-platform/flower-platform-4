...
package org.flowerplatform.flex_client.mindmap.action {
	...
	public class NodeRightAction extends AbstractNavigateAction {
		...
		public static const ID:String = "org.flowerplatform.flex_client.mindmap.action.NodeRightAction";
		
		public function NodeRightAction(appendNodesToCurrentSelection:Boolean = false) {
			super(Resources.getMessage("mindmap.right"), new Shortcut(false, appendNodesToCurrentSelection, false, Keyboard.RIGHT), appendNodesToCurrentSelection);			
		}
