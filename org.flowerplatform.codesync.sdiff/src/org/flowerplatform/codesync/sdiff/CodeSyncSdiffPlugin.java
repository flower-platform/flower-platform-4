...
public class CodeSyncSdiffPlugin extends AbstractFlowerJavaPlugin {
	...
	public void start(BundleContext bundleContext) throws Exception {
		...
		CorePlugin.getInstance().getNodeTypeDescriptorRegistry().getOrCreateTypeDescriptor(STRUCTURE_DIFF_LEGEND_CHILDREN)
		.addAdditiveController(PROPERTIES_PROVIDER, new StructureDiffLegendChildrenPropertiesProvider());
		
		CorePlugin.getInstance().getResourceService().addResourceHandler(STRUCTURE_DIFF_LEGEND_CHILDREN, new BaseResourceHandler(STRUCTURE_DIFF_LEGEND_CHILDREN));
		...
		CorePlugin.getInstance().getResourceService().addResourceHandler(STRUCTURE_DIFF_LEGEND, new BaseResourceHandler(STRUCTURE_DIFF_LEGEND));
