...
package org.flowerplatform.flex_client.host_app.mobile.view_edit_server_account {
	...
	public class EditServerAccountViewProvider extends AbstractViewProvider {
		
		public static const ID:String = "editServerAccount";
		...
		override public function createView(viewLayoutData:ViewLayoutData):UIComponent {			
			return new EditServerAccountView();
		}
