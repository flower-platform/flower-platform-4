 ...
 * @author Elena Posea
 */
public class CodeSyncCommentPropagationTest extends CodeSyncEclipseIndependentTestBase {
	...
	public void testAddCommentPropagation() {
		...
		Node testNode = getChild(root, new String[] { "CodeSyncSdiffConstants.java", "CodeSyncSdiffConstants", "STRUCTURE_DIFFS_FOLDER" });
		...
		properties.put(TYPE_KEY, COMMENT);
		String comment1NodeFullyQualifiedName = nodeServiceRemote.addChild(testNodeFullyQualifiedName, properties);
	...
	public void testRemoveCommentButNotTheLastDirtyChild() {
		...
		Node testNode = getChild(root, new String[] { "CodeSyncSdiffPlugin.java", "CodeSyncSdiffPlugin", "registerMessageBundle()", "myMessage" });
		String testNodeFullyQualifiedName = testNode.getNodeUri();
	...
	public void testRemoveNodeWithCommentButNotTheLastDirtyChild() {
		...
		Node testNode = getChild(root, new String[] { "CodeSyncSdiffPlugin.java", "CodeSyncSdiffPlugin", "registerMessageBundle()" });
		String testNodeFullyQualifiedName = testNode.getNodeUri();
	...
	public void testRemoveLastComment() {
		...
		// get testNode
		Node testNode = getChild(root, new String[] { "CodeSyncSdiffPlugin.java", "CodeSyncSdiffPlugin", "registerMessageBundle()", "myComment" });
		String testNodeFullyQualifiedName = testNode.getNodeUri();
